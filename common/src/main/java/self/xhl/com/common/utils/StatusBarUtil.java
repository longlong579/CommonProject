...
//        }
    ...
    public static boolean getCanMakeStatusBarBlackFont(Activity activity) {
        boolean isMakeStatusBarBlack = false;
//        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.KITKAT) {
//            if (isMIOS()) {
//                isMakeStatusBarBlack = true;
//                MIUISetStatusBarLightMode(activity.getWindow(), true);
//            }
//            if (isFlyMeOS()) {
//                isMakeStatusBarBlack = true;
