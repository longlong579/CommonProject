package self.xhl.com.common.widget.bottombar;
...
//        shadowView.setBackgroundResource(R.drawable-hdpi.actionbar_shadow_up);
//        addView(shadowView, new LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
    ...
    public BottomBar addItem(final BottomBarTab tab) {
        tab.setSelectColor(colorSelected);
        tab.setUnSelectColor(colorUnselected);
    ...
    public BottomBar setSelectColor(@ColorRes int selectColor) {
        this.colorSelected = ContextCompat.getColor(getContext(), selectColor);
        return this;
    }

    public BottomBar setUnSelectColor(@ColorRes int unSelectColor) {
        this.colorUnselected = ContextCompat.getColor(getContext(), unSelectColor);
        return this;
    }
}
