...
public class BottomBarTab extends FrameLayout {
    ...
    private void init(Context context, int icon, CharSequence title) {
        ...
        mIcon.setColorFilter(colorUnselected);
        ...
        mTvTitle.setTextColor(colorUnselected);
    ...
    public void setSelected(boolean selected) {
        ...
        if (selected) {
            mIcon.setColorFilter(colorSelected);
            mTvTitle.setTextColor(colorSelected);
        } else {
            mIcon.setColorFilter(colorUnselected);
            mTvTitle.setTextColor(colorUnselected);
        }
    ...
    void setSelectColor( int selectColor) {
        this.colorSelected = selectColor;
    }
    void setUnSelectColor(int unSelectColor) {
        this.colorUnselected = unSelectColor;
    }
}
