...
public class MyBottomSheetDialog extends AppCompatDialog {
    ...
    protected void onStart() {
        super.onStart();
        if (mBehavior != null) {
//            mBehavior.setState(BottomSheetBehavior.STATE_COLLAPSED);//折叠状态
            mBehavior.setState(BottomSheetBehavior.STATE_EXPANDED);//全展开
        }
    }
    ...
    private View wrapInBottomSheet(int layoutResId, View view, ViewGroup.LayoutParams params) {
        ...
        bottomSheet.setBackground(new ColorDrawable(Color.TRANSPARENT));//内容背景透明
