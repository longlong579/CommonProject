...
import kotlinx.android.synthetic.main.activity_lazyload.*
import self.xhl.com.common.baseui.baseactivity.PermissionBaseActivity
import self.xhl.com.commonproject.R

/**
 * add模式懒加载 已做异常退出处理
 * Activity+Fragment 懒加载 异常退出保存数据测试
 */
class AddModuleLazyLoadActivity : PermissionBaseActivity() {
    ...
    override fun getContentLayoutId(): Int {
     return  R.layout.activity_lazyload
    }

    override fun initToolBarPre() {
        ToolBarBuild().setToolBarTitle("Add模式下Fragment的懒加载")
    }
...
//        setContentView(R.layout.activity_main2)
   ...
   private fun hideAllFragment(mTra: FragmentTransaction) {
    ...
    //异常退出恢复
   private fun reStoreSaveInstance(inState: Bundle) {
