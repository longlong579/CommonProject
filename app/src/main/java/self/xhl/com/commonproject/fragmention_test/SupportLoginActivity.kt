package self.xhl.com.commonproject.fragmention_test
...
class SupportLoginActivity : PermissionBaseActivity() {
    ...
    override fun initWidget() {
        ...
        checkForcePermissions(object :OnPermissionResultListener{
         ...
         if(findFragment(SupportLoginFragment::class.java)==null)
         {
             loadRootFragment(R.id.fl_container, SupportLoginFragment.newInstance())
         }
        closeAndroidPDialog()
    }
